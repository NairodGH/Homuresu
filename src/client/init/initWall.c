...
{
    list_push_data(game->cube, createWall((Vector3){ 0.0f, 0.0f, -16.0f }, 32.0f, 16.0f, 0.1f));
    list_push_data(game->cube, createWall((Vector3){ 0.0f, 0.0f, 16.0f }, 32.0f, 16.0f, 0.1f));
    list_push_data(game->cube, createWall((Vector3){ 16.0f, 0.0f, 0.0f }, 0.1f, 16.0f, 32.0f));
    list_push_data(game->cube, createWall((Vector3){ -16.0f, 0.0f, 0.0f }, 0.1f, 16.0f, 32.0f));
}
